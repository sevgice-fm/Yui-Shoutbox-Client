...
$l['yuishoutbox_shoutlimit_desc'] = 'Set here amount of shouts that will appear in shout area.';
$l['yuishoutbox_logshoutlimit_title'] = 'Amount of shouts in log (archive)';
$l['yuishoutbox_logshoutlimit_desc'] = 'Set here amount of shouts that will appear in log (archive).';
